...
export const loadConfigFromProcess = (): BotConfig => loadConfig({
  DISCORD_APPLICATION_ID: process.env.DISCORD_APPLICATION_ID,
  DISCORD_PUBLIC_KEY: process.env.DISCORD_PUBLIC_KEY,
  DISCORD_BOT_TOKEN: process.env.DISCORD_BOT_TOKEN,
  DISCORD_GUILD_ID: process.env.DISCORD_GUILD_ID,
  DISCORD_ANNOUNCEMENTS_CHANNEL_ID: process.env.DISCORD_ANNOUNCEMENTS_CHANNEL_ID,
  DISCORD_RUN_JOURNALS_CHANNEL_ID: process.env.DISCORD_RUN_JOURNALS_CHANNEL_ID,
  DISCORD_VERIFICATION_QUEUE_CHANNEL_ID: process.env.DISCORD_VERIFICATION_QUEUE_CHANNEL_ID,
  DISCORD_AUDIT_LOG_CHANNEL_ID: process.env.DISCORD_AUDIT_LOG_CHANNEL_ID,
  DISCORD_RULES_CHANNEL_ID: process.env.DISCORD_RULES_CHANNEL_ID,
  DISCORD_MODERATOR_ROLE_ID: process.env.DISCORD_MODERATOR_ROLE_ID,
  DISCORD_ADMINISTRATOR_ROLE_ID: process.env.DISCORD_ADMINISTRATOR_ROLE_ID,
  DISCORD_FATEKEEPER_ROLE_ID: process.env.DISCORD_FATEKEEPER_ROLE_ID,
  DISCORD_VERIFIED_RUNNER_ROLE_ID: process.env.DISCORD_VERIFIED_RUNNER_ROLE_ID,
  DISCORD_UPDATES_ROLE_ID: process.env.DISCORD_UPDATES_ROLE_ID,
  DISCORD_WEEKLY_SEED_ROLE_ID: process.env.DISCORD_WEEKLY_SEED_ROLE_ID,
  DISCORD_TAG_VANILLA_ID: process.env.DISCORD_TAG_VANILLA_ID,
  DISCORD_TAG_CHUNKED_ID: process.env.DISCORD_TAG_CHUNKED_ID,
  DISCORD_TAG_CUSTOM_ID: process.env.DISCORD_TAG_CUSTOM_ID,
  DISCORD_TAG_ACTIVE_ID: process.env.DISCORD_TAG_ACTIVE_ID,
  DISCORD_TAG_VERIFIED_ID: process.env.DISCORD_TAG_VERIFIED_ID,
  DISCORD_COMPONENT_HMAC_KEY: process.env.DISCORD_COMPONENT_HMAC_KEY,
  AUTOMATION_HMAC_KEY: process.env.AUTOMATION_HMAC_KEY,
  AUTOMATION_ALLOWED_REPOSITORIES: process.env.AUTOMATION_ALLOWED_REPOSITORIES,
  DISCORD_MUTATIONS_ENABLED: process.env.DISCORD_MUTATIONS_ENABLED,
});
