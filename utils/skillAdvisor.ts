...
export function rankSkillBottlenecks(unlocks: any, gameModeId?: string): RankedSkill[] {
  ...
  const blockerCanChange = (
    ...
    if (blocker.kind === 'region' || blocker.kind === 'equipment' || blocker.kind === 'merchant' || blocker.kind === 'mobility' || blocker.kind === 'arcana' || blocker.kind === 'minigame' || blocker.kind === 'boss') return false;
