/**
 * Single source of truth for which areas are free at the start of a run.
 *
...
/** Set the free baseline from a mode's startArea ('lumbridge' | 'misthalin'). */
export const setStartArea = (startArea?: string): void => {
  current = startArea === 'lumbridge' ? LUMBRIDGE_ONLY : FULL_MISTHALIN;
};
