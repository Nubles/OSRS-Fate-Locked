...
export const REGION_CHUNKS: Record<string, ChunkCoord[]> = {
  ...
  'Fremennik': [
    { cx: 39, cy: 56 }, { cx: 40, cy: 56 }, { cx: 40, cy: 57 }, { cx: 41, cy: 57 }, { cx: 42, cy: 57 }, { cx: 43, cy: 57 }, { cx: 39, cy: 58 }, { cx: 41, cy: 58 }, { cx: 42, cy: 58 },
  ...
  'Karamja': [
    ...
    { cx: 43, cy: 49 }, { cx: 44, cy: 49 }, { cx: 45, cy: 49 }, { cx: 42, cy: 50 }, { cx: 43, cy: 50 }, { cx: 44, cy: 50 },
    { cx: 44, cy: 51 },
    { cx: 42, cy: 46 },
  ],
  'Kharidian Desert': [
  ...
  'The Open Seas': [
    { cx: 39, cy: 34 }, { cx: 40, cy: 34 }, { cx: 52, cy: 34 }, { cx: 36, cy: 35 }, { cx: 39, cy: 35 }, { cx: 40, cy: 35 }, { cx: 46, cy: 35 }, { cx: 34, cy: 36 }, { cx: 41, cy: 37 }, { cx: 50, cy: 37 }, { cx: 51, cy: 37 }, { cx: 48, cy: 38 },
