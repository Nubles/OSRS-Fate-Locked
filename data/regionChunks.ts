...
export const REGION_CHUNKS: Record<string, ChunkCoord[]> = {
  'Asgarnia': [
    { cx: 41, cy: 40 }, { cx: 41, cy: 41 }, { cx: 46, cy: 48 }, { cx: 46, cy: 49 }, { cx: 47, cy: 49 }, { cx: 45, cy: 50 }, { cx: 46, cy: 50 }, { cx: 47, cy: 50 }, { cx: 45, cy: 51 }, { cx: 46, cy: 51 }, { cx: 47, cy: 51 },
    { cx: 43, cy: 52 }, { cx: 44, cy: 52 }, { cx: 45, cy: 52 }, { cx: 46, cy: 52 }, { cx: 47, cy: 52 }, { cx: 45, cy: 53 }, { cx: 46, cy: 53 }, { cx: 47, cy: 53 },
    { cx: 44, cy: 54 }, { cx: 45, cy: 54 }, { cx: 46, cy: 54 }, { cx: 44, cy: 55 }, { cx: 45, cy: 55 }, { cx: 46, cy: 55 }, { cx: 44, cy: 56 },
  ...
  'Fremennik': [
    ...
    { cx: 38, cy: 62 }, { cx: 41, cy: 62 }, { cx: 44, cy: 62 }, { cx: 35, cy: 63 },
    { cx: 41, cy: 63 },
  ],
  'Kandarin': [
    ...
    { cx: 39, cy: 51 }, { cx: 40, cy: 51 }, { cx: 41, cy: 51 }, { cx: 42, cy: 51 }, { cx: 43, cy: 51 }, { cx: 36, cy: 52 }, { cx: 38, cy: 52 }, { cx: 39, cy: 52 },
  ...
  'Karamja': [
    ...
    { cx: 46, cy: 46 }, { cx: 43, cy: 47 }, { cx: 44, cy: 47 }, { cx: 45, cy: 47 }, { cx: 46, cy: 47 }, { cx: 43, cy: 48 }, { cx: 44, cy: 48 }, { cx: 45, cy: 48 },
    { cx: 42, cy: 49 }, { cx: 43, cy: 49 }, { cx: 44, cy: 49 }, { cx: 45, cy: 49 }, { cx: 42, cy: 50 }, { cx: 43, cy: 50 },
    { cx: 44, cy: 50 },
    { cx: 44, cy: 51 },
  ],
  'Kharidian Desert': [
  ...
  'Kourend & Kebos': [
    ...
    { cx: 24, cy: 55 }, { cx: 25, cy: 55 }, { cx: 26, cy: 55 }, { cx: 27, cy: 55 }, { cx: 28, cy: 55 }, { cx: 29, cy: 55 }, { cx: 18, cy: 56 }, { cx: 19, cy: 56 },
    { cx: 20, cy: 56 }, { cx: 21, cy: 56 }, { cx: 22, cy: 56 }, { cx: 23, cy: 56 }, { cx: 24, cy: 56 }, { cx: 25, cy: 56 }, { cx: 26, cy: 56 }, { cx: 27, cy: 56 },
    { cx: 28, cy: 56 }, { cx: 18, cy: 57 }, { cx: 19, cy: 57 }, { cx: 20, cy: 57 }, { cx: 21, cy: 57 }, { cx: 22, cy: 57 }, { cx: 23, cy: 57 }, { cx: 24, cy: 57 },
    { cx: 25, cy: 57 }, { cx: 26, cy: 57 }, { cx: 27, cy: 57 }, { cx: 28, cy: 57 }, { cx: 18, cy: 58 }, { cx: 19, cy: 58 }, { cx: 20, cy: 58 }, { cx: 21, cy: 58 },
    { cx: 22, cy: 58 }, { cx: 23, cy: 58 }, { cx: 24, cy: 58 }, { cx: 25, cy: 58 }, { cx: 26, cy: 58 }, { cx: 27, cy: 58 }, { cx: 28, cy: 58 }, { cx: 18, cy: 59 },
    { cx: 19, cy: 59 }, { cx: 20, cy: 59 }, { cx: 21, cy: 59 }, { cx: 22, cy: 59 }, { cx: 23, cy: 59 }, { cx: 24, cy: 59 }, { cx: 25, cy: 59 }, { cx: 26, cy: 59 },
    { cx: 27, cy: 59 }, { cx: 28, cy: 59 }, { cx: 20, cy: 60 }, { cx: 22, cy: 60 }, { cx: 23, cy: 60 }, { cx: 24, cy: 60 }, { cx: 25, cy: 60 }, { cx: 26, cy: 60 },
    { cx: 27, cy: 60 }, { cx: 28, cy: 60 }, { cx: 23, cy: 61 }, { cx: 24, cy: 61 }, { cx: 25, cy: 61 }, { cx: 26, cy: 61 }, { cx: 27, cy: 61 },
    { cx: 25, cy: 62 },
  ],
  'Misthalin': [
    { cx: 48, cy: 49 }, { cx: 49, cy: 49 }, { cx: 50, cy: 49 }, { cx: 48, cy: 50 }, { cx: 49, cy: 50 }, { cx: 50, cy: 50 },
    { cx: 48, cy: 51 }, { cx: 49, cy: 51 }, { cx: 50, cy: 51 }, { cx: 48, cy: 52 }, { cx: 49, cy: 52 },
    { cx: 50, cy: 52 }, { cx: 51, cy: 52 }, { cx: 52, cy: 52 }, { cx: 48, cy: 53 }, { cx: 49, cy: 53 }, { cx: 50, cy: 53 },
    { cx: 51, cy: 53 }, { cx: 52, cy: 53 }, { cx: 47, cy: 54 }, { cx: 48, cy: 54 }, { cx: 49, cy: 54 }, { cx: 50, cy: 54 }, { cx: 51, cy: 54 },
  ...
  'Morytania': [
    ...
    { cx: 59, cy: 47 }, { cx: 60, cy: 47 }, { cx: 54, cy: 49 }, { cx: 55, cy: 49 }, { cx: 56, cy: 49 }, { cx: 57, cy: 49 }, { cx: 53, cy: 50 }, { cx: 54, cy: 50 }, { cx: 55, cy: 50 }, { cx: 56, cy: 50 },
    { cx: 57, cy: 50 }, { cx: 58, cy: 50 }, { cx: 53, cy: 51 }, { cx: 54, cy: 51 }, { cx: 55, cy: 51 }, { cx: 56, cy: 51 }, { cx: 57, cy: 51 }, { cx: 58, cy: 51 }, { cx: 53, cy: 52 }, { cx: 54, cy: 52 },
    { cx: 55, cy: 52 }, { cx: 56, cy: 52 }, { cx: 57, cy: 52 }, { cx: 58, cy: 52 }, { cx: 53, cy: 53 }, { cx: 54, cy: 53 }, { cx: 55, cy: 53 }, { cx: 56, cy: 53 }, { cx: 57, cy: 53 },
  ...
  'Tirannwn': [
    ...
    { cx: 35, cy: 51 }, { cx: 36, cy: 51 }, { cx: 37, cy: 51 }, { cx: 33, cy: 52 }, { cx: 34, cy: 52 }, { cx: 35, cy: 52 }, { cx: 37, cy: 52 }, { cx: 33, cy: 53 }, { cx: 34, cy: 53 },
    { cx: 35, cy: 53 },
  ],
  'Varlamore': [
  ...
  'The Open Seas': [
    { cx: 39, cy: 34 }, { cx: 40, cy: 34 }, { cx: 52, cy: 34 }, { cx: 36, cy: 35 }, { cx: 39, cy: 35 }, { cx: 40, cy: 35 }, { cx: 46, cy: 35 }, { cx: 34, cy: 36 }, { cx: 44, cy: 36 }, { cx: 49, cy: 36 }, { cx: 50, cy: 36 }, { cx: 51, cy: 36 },
    { cx: 41, cy: 37 }, { cx: 48, cy: 37 }, { cx: 49, cy: 37 }, { cx: 50, cy: 37 }, { cx: 51, cy: 37 }, { cx: 48, cy: 38 }, { cx: 49, cy: 38 }, { cx: 50, cy: 38 },
    { cx: 51, cy: 38 }, { cx: 39, cy: 39 }, { cx: 43, cy: 39 }, { cx: 48, cy: 39 }, { cx: 49, cy: 39 }, { cx: 50, cy: 39 }, { cx: 32, cy: 40 }, { cx: 46, cy: 40 },
    { cx: 27, cy: 41 }, { cx: 47, cy: 41 }, { cx: 18, cy: 42 }, { cx: 38, cy: 42 }, { cx: 17, cy: 43 }, { cx: 18, cy: 43 }, { cx: 19, cy: 43 }, { cx: 24, cy: 43 },
    { cx: 30, cy: 43 }, { cx: 36, cy: 43 }, { cx: 45, cy: 44 },
    { cx: 29, cy: 46 }, { cx: 47, cy: 46 }, { cx: 30, cy: 48 }, { cx: 32, cy: 49 }, { cx: 29, cy: 51 }, { cx: 29, cy: 53 }, { cx: 34, cy: 54 }, { cx: 33, cy: 55 }, { cx: 32, cy: 57 }, { cx: 30, cy: 63 }, { cx: 45, cy: 63 },
  ],
};
