...
export const ALL_DIARY_TASKS: DiaryTask[] = [
  ...
  { id: 'mor_elite_1', tierId: 'Morytania Elite', description: 'Catch a shark in Burgh de Rott with your bare hands.', skills: { 'Fishing': 96, 'Strength': 76 }, quests: ['In Aid of the Myreque', 'Barbarian Training'], regions: ['Burgh de Rott'] },
