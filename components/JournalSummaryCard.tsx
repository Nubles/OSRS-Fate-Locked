...
import { BookOpen, Map as MapIcon, Swords, ChevronRight, Sparkles } from 'lucide-react';
 ...
 * count and progress bar.  Clicking anything navigates straight to the
 * relevant Journal sub-tab.
 */
